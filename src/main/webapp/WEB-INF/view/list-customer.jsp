    ...
    <div id="content">
        ...
        <table>
            <tr>
                ...
                <security:authorize access="hasAnyRole('OWNER', 'MANAGER', 'ADMIN')">
                    <th>Action</th>
                </security:authorize>
            </tr>
            ...
            <c:forEach var="tempCustomer" items="${customers}">
                ...
                <tr>
                    ...
                    <td>
                        <security:authorize access="hasAnyRole('OWNER', 'MANAGER')">
                            <a href="${updateLink}">Update</a> </security:authorize>
                        <security:authorize access="hasAnyRole('OWNER', 'ADMIN')">|<a href="${deleteLink}"
